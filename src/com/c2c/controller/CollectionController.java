...
public class CollectionController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/deleteCollectionGoods/{id}")
    public String deleteCollectionGoods(HttpServletRequest request,@PathVariable("id") Integer id) throws Exception {
    	collectionservice.deleteCollectionGoods(id);
