...
<div class="main-content">
    ...
    <div class="slider-wapper">
		...
		<div class="img-div" >
			<img src="<%=basePath%>img/l2.jpg" title="图片1"/>
			<img src="<%=basePath%>img/l1.jpg" title="图片2"/>
			<img src="<%=basePath%>img/l3.jpg" title="图片3"/>
		</div>
		<div class="slide-btn">
...
var zBase = {
	...
	play:function(){
		this.slide.timer = setInterval(function(){
			...
			zBase.animate(zBase.img_div,zBase.config.direct,-zBase.config.index*900);
